...
print(f'Выбираем минимальные редакционные расстояния из всех животных к строке "{man}":')
for a, b in man_names_values.items():
    if b <= 2:
        print(f'Между строками "{man}" и "{a}" - {b}.')


print(f'Выбираем минимальные редакционные расстояния из всех животных к строке "{girl}":')
